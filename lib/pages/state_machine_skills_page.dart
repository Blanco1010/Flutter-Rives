...
class StateMachineSkillsPage extends StatefulWidget {
  const StateMachineSkillsPage({Key? key}) : super(key: key);

  @override
  _StateMachineSkillsPageState createState() => _StateMachineSkillsPageState();
}

class _StateMachineSkillsPageState extends State<StateMachineSkillsPage> {
