...
class ExampleStateMachinePage extends StatefulWidget {
  const ExampleStateMachinePage({Key? key}) : super(key: key);

  @override
  _ExampleStateMachinePageState createState() =>
      _ExampleStateMachinePageState();
}

class _ExampleStateMachinePageState extends State<ExampleStateMachinePage> {
